...
function colors(color) {
  ...
  if(color === "blue"){return "This is blue"} if(color === "red"){return "This is red"} if(color === "green"){return "This is green"}
...
function tieneTresDigitos(numero){
  ...
  if (toString.length === 3){return true} return false
}
